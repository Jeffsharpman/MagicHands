...
const Icons = {
  portfolio: (
    <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 fill-current">
      <path d="M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm-1 17.93c-3.94-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z" />
    </svg>
  ),
  github: (
    <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 fill-current">
    ...
    >
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          {[
            { label: "Portfolio", href: DEVELOPER.portfolio, icon: Icons.portfolio },
            { label: "GitHub", href: DEVELOPER.github, icon: Icons.github },
            { label: "LinkedIn", href: DEVELOPER.linkedin, icon: Icons.linkedin },
            { label: "X / Twitter", href: DEVELOPER.twitter, icon: Icons.twitter },
            { label: "Instagram", href: DEVELOPER.instagram, icon: Icons.instagram },
            { label: "YouTube", href: DEVELOPER.youtube, icon: Icons.youtube },
            { label: "Facebook", href: DEVELOPER.facebook, icon: Icons.facebook },
          ].map((link) => (
            <a
              key={link.label}
              href={link.href}
